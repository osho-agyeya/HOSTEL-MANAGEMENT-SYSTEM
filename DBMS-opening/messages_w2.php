...
.full {
    background: url(mess.png) no-repeat center center fixed;
...
<body>
    <div id="wrapper">
        ...
        <div id="overview">
        <center>
            <h1><b><font size=6 ><u>MESSAGES TERMINAL</font></u></b></h1>
        </center>
        <form action="messages_w.php" method="post">
			<center>
			<h1><b><font size=5>Enter the message:</font></b></h1><br>
			<textarea name="message" placeholder="Enter the message" cols="40" rows="9"></textarea>
			<br><input type="submit" name="sub" value="SUBMIT" class="btn btn-default"/>
			</center>
		</form>	
