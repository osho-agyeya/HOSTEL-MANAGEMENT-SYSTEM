...
.full {
  background: url(orders.jpg) no-repeat center center fixed; 
...
<body>
    <div id="wrapper">
        ...
        <div id="overview">
            <center>
            <h1><b><font size=6 ><u>ORDERS</font></u></b></h1>
        <?php
            $i=0;
            $query1="SELECT * from orders order by num desc limit 0,5 ;";
            ...
            if($row['flag']=='PENDING')    
            {
                echo 
                              ...
                              <div class='sep'></div>
                              <p>Registration number:$row[reg_no] &nbsp &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Name:$row[name_stud]</p>
                              <p>Room:$row[room_stud]&nbsp &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                              <p>DOA:$row[doa]</p>
                              <h3>Order Status: Not Evaluated</h3>
                              </div><br>";
            }
             else if ($row['flag']=='ACCEPTED'){
                echo 
                              "<div class='container1' id='signup'>
                              <div class='header'>
                              <h3>Leave form details</h3>
                              ...
                              <p>Room:$row[room_stud]&nbsp &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                              <p>DOA:$row[doa]</p>
                              <h3>Order Status: Accepted</h3>
                              </div><br>";
             }
         }
        ?>
<a href="#menu-toggle" class="btn btn-default" id="menu-toggle">Toggle Menu</a>&nbsp&nbsp&nbsp&nbsp
