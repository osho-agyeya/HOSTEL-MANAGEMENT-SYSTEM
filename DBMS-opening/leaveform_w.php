    ...
    <div id="wrapper">
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
                <li>
                    <a class="one" href="index3_w.php"><font size=3><b>Dashboard</b></font></a>
                </li>
                <li>
                    <a class="one" href="orders_w.html"><font size=3><b>Orders</b></font></a>
                </li>
                <li>
                    <a class="one" href="leaveform_w.php"><font size=3><b>Leave forms</b></font></a>
                </li>
                <li>
                    <a class="one" href="messages_w.html"><font size=3><b>Messages Terminal</b></font></a>
                </li>
                <li>
                    <a class="one" href="status_layout_w.php"><font size=3><b>Complains</b></font></a>
                </li>
                <li>
        ...
        <h1 align="center">The Student Leave Forms Are Here.</h1>
        <?php
        	$query="SELECT * from leavef order by temp desc;";
			$rep=@mysql_query($query);
			$sq="SELECT  MAX(temp) from leavef";
			$res=@mysql_query($sq);
			while($r=@mysql_fetch_array($res))
			{$count1=$r[0];}
			$sq2="SELECT  MIN(temp) from leavef";
			...
			while($row=@mysql_fetch_array($rep))
			{
				if($row['flag']==0)
					{	
						echo "<div class='container1' id='signup'>
							  <div class='header'>
            				  <h3>Leave form details</h3>
        					  </div>
        					  <div class='sep'></div>
							  <p>Registration number:$row[id] &nbsp &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Name:$row[name]</p>
		                      <p>Authority:$row[auth] &nbsp &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Reason:$row[reason]</p>
		                      <p>Address:$row[ladd]</p>
		                      <p>DOI:$row[dol] &nbsp &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp DOA:$row[doa]</p>
                              <input type='submit' class='myB' value='Accept' name='accept$count1'>
                              &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
           					  <input type='submit' class='myB' value='Reject' name='reject$count1'>
           					  </div>";
           				$count1--;
           			}
           		else if($row['flag']==-1)
           		{		echo "<div class='container1' id='signup'>
		                      ...
		                      <p>Address:$row[ladd]</p>
		                      <p>DOI:$row[dol] &nbsp &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp DOA:$row[doa]</p>
                              NO&nbsp &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
		                      	  &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
		                      <input type='submit' class='myB' value='Reset' name='reset$count1'>
		                      </div>";
           				$count1--;
           		}
           		else
           		{		echo "<div class='container1' id='signup'>
		                      ...
		                      <p>Address:$row[ladd]</p>
		                      <p>DOI:$row[dol] &nbsp &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp DOA:$row[doa]</p>
                              Yes&nbsp &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
			...
			for($j=$count2;$j<=$i;$j++)
		{
			...
			{
				$query2="update leavef set flag=1 where temp=$j;";
				mysql_query($query2);
				echo "<meta http-equiv='refresh' content='0'>";
			}
			else if(isset($_POST["reject$j"]))
			{
				$query3="update leavef set flag=-1 where temp=$j;";
				mysql_query($query3);
				echo "<meta http-equiv='refresh' content='0'>";
			}
			else if(isset($_POST["reset$j"]))
			{
				$query4="update leavef set flag=0 where temp=$j;";
